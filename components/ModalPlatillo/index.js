      ...
      <div className={modal.cardModal}>
        <div className={modal.bodyModal}>
          <div className={modal.carruselModal}>
            <img
              src="https://static.vecteezy.com/system/resources/previews/007/151/370/non_2x/stylized-inscription-ufo-with-a-flying-saucer-through-the-letter-drawn-as-a-planet-black-and-white-image-on-an-isolated-background-vector.jpg"
              alt="muestra"
            />
          </div>
