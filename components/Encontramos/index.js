            ...
            <div>
              <div>
                <h1 className="text-center text-white text-3xl md:text-4xl uppercase font-black">
                  Vive México en el Corazón de la Roma Condesa, Ciudad de México
                </h1>
                <p className="text-white text-center text-lg md:text-xl mt-2">
                  Descubre los vibrantes sabores de México en nuestra cantina
                  única, ubicada en el trendy barrio de Roma Condesa.
                </p>
              </div>
              <div>
