    ...
    <>
      {espa ? (
        <div className="container-llorona px-2">
          ...
          <div className="py-3 px-3 row-qh">
            <p className="text-center sm:text-2xl text-xl text-black">
              Inmérsete en la cultura mexicana con la propuesta de la{' '}
              <b>Llorona que es única y original</b>, prueba nuestra amplia
              selección de <b>Cervezas artesanales mexicanas</b> provenientes de
              diferentes partes de México, desde el Norte hasta el Sur. También
              disfruta de nuestra mixología de autor creada por los mejores
              mixólogos de México que nos deleitan con sabores con{' '}
              <b>Aguacate en nuestro Famoso Martiní de aguacate con Mezcal</b>,
              o nuestro singular <b>Burrito Mexicano</b> que es una modificación
              al coctel Moscow Mule pero con cerveza mexicana y Vodka de
              tamarindo.
            </p>
          </div>
          <div
        ...
        <div className="container-llorona px-2">
          ...
          <div className="py-3 px-3 row-qh">
            <p className="text-center sm:text-2xl text-xl text-black">
              If you're looking to explore a wide selection of{' '}
              <b>Mexican craft beers </b> or indulge in mixology with Mexican
              flavors featuring Mezcal and Tequila, this is the place to be.
              Enjoy our <b>Avocado Martini or Mazapan Martini </b>, or try some
              of our cocktails made with Pulque, an ancient Mexican beverage.
              Experience the fusion of tradition and innovation in every sip!
            </p>
          </div>
          <div
            style={{
