...
const TestimonialCard = ({ testimonial }) => {
  ...
  return (
    <a
      href={url}
      target="_blank"
      className="flex flex-col justify-center items-center px-8 py-4 bg-black rounded-xl shadow-md "
    >
...
const CarouselRevistas = ({ testimonials }) => {
  return (
    <div className="relative max-w-[1080px] mx-auto bg-white">
...
export default CarouselRevistas;
