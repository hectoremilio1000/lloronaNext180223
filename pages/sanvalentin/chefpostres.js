      ...
      <div className="w-full bg-red-800 py-[150px] ">
        <div className="max-w-[1300px] grid-col-reverse mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
            ...
            {espa ? (
              <>
                ...
                <p className="text-white">
                  ¡Estamos cocinado un nuevo menú! Si reservas este 14 de
                  febrero, nuestro chef te preparará un postre especialmente
                  para Ti.
                </p>
              ...
              <>
                ...
                <p className="text-white">
                  We're cooking up a new menu! If you book this February 14th,
                  our chef will prepare a dessert especially for You.
                </p>
          ...
          <div className="w-full order-1 md:order-2">
            <img src="../../images/promociones/postre3.jpeg" alt="" />
          </div>
        </div>
      </div>
    </>
