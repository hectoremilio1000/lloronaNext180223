      ...
      <div className="w-full bg-red-800 py-[150px] ">
        <div className="max-w-[1300px] grid-col-reverse mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
            ...
            {espa ? (
              <>
                ...
                <p className="text-white">
                  ¡Estamos transformándonos, un nuevo menú te espera! Si
                  reservas este 14 de febrero, nuestro chef tiene un postre
                  especial para Ti
                </p>
              ...
              <>
                ...
                <p className="text-white">
                  ...
                  February 14th, our chef has a special dessert for You
                </p>
          ...
          <div className="w-full order-1 md:order-2">
            <img src="../../images/promociones/postre1.jpeg" alt="" />
          </div>
        </div>
      </div>
    </>
