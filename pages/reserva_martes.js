...
function Reserva() {
  ...
  useEffect(() => {
    fbq.event('ViewContent', {
      content_name: 'Pagina Reserva Martes',
  ...
  return (
    <>
      ...
      <>
        {espa ? (
          <Head>
            <title>Cantina abierta los martes en la Roma | Cantina La Llorona</title>
            <meta name="description" content="Reserva tu martes en Cantina La Llorona, Roma Condesa. Ambiente de cantina mexicana, mezcales artesanales y pinata cumpleañera con botella de mezcal para tu festejo." />
            <link rel="canonical" href="https://lalloronacantina.com/reserva_martes/" />
            <meta property="og:title" content="Cantina abierta los martes en la Roma | Cantina La Llorona" />
            <meta property="og:description" content="Reserva tu martes en Cantina La Llorona, Roma Condesa. Ambiente de cantina mexicana, mezcales artesanales y pinata cumpleañera con botella de mezcal para tu festejo." />
            <meta property="og:url" content="https://lalloronacantina.com/reserva_martes/" />
          ...
          <Head>
            <title>Open on Tuesdays in Roma, Mexico City | Cantina La Llorona</title>
            <meta name="description" content="Book your Tuesday at Cantina La Llorona in Roma Condesa. Mexican cantina vibe, artisanal mezcal and a birthday pinata with a bottle of mezcal." />
            <link rel="canonical" href="https://lalloronacantina.com/reserva_martes/" />
            <meta property="og:title" content="Open on Tuesdays in Roma, Mexico City | Cantina La Llorona" />
            <meta property="og:description" content="Book your Tuesday at Cantina La Llorona in Roma Condesa. Mexican cantina vibe, artisanal mezcal and a birthday pinata with a bottle of mezcal." />
            <meta property="og:url" content="https://lalloronacantina.com/reserva_martes/" />
            <meta property="og:type" content="website" />
            <Script
              strategy="beforeInteractive"
              ...
              <div className="w-full max-w-[1184px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-8 text-center">
                <div className="w-full">
                  <h1 className="font-bold text-4xl text-white">
                    {' '}
                    Los martes piñata cumpleañera con botella de mezcal
                    artesanal
                  </h1>
                  ...
                  <p className="text-start text-white sm:text-xs md:text-md mt-3">
                    ...
                    los martes si cumples años en el mes ❤️ y solo tienen que
