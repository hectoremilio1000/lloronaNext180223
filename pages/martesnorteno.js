  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.ttq) {
      window.ttq.track('ViewContent', {
        ...
        description: 'landing_norteno_tiktok',
      });
    }
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://lalloronacantina.com/martesnorteno/" />
        <meta property="og:title" content="Martes de Norteño | Cantina La Llorona" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://lalloronacantina.com/martesnorteno/" />
        <meta property="og:image" content="https://lalloronacantina.com/norteno_banda.png" />
        <meta
