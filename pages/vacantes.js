    ...
    <>
      ...
      <div className="py-3 px-4 row-qh">
        <p className="text-justify sm:text-2xl text-xl text-black">
          Experiencia mínima de 6 meses (comprobable, INDISPENSABLE contar con
          cartas de recomendación o constancias laborales) en restaurantes
          establecidos o de cadena.
        </p>
