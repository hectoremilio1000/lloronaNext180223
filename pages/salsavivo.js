      ...
      <>
          <div className="d-flex subContenedor1Banner bannerSalsa banner">
              <div className="d-flex w-44 sm:w-60 md:w-80 mx-2 title-portada">
                  <div className="d-flex w-44 sm:w-60 md:w-80 mx-2 title-portada">
                      {espa ? <h3 className=" font-weight-bold proximamente2 text-white">
                          Los mejores grupos de <br />
                          Salsa en Vivo
                      </h3> : <h3 className=" font-weight-bold proximamente2 text-white">
              ...
              {espa ?
                  <>
                      ...
                      <div className="container-llorona px-4">
                          ...
                          <div className="py-3 px-4 row-qh">
                              <p className="text-center sm:text-2xl text-xl text-black">
                                  ...
                                  <br />
                                  Déjate llevar por el vaivén de la salsa, ritmo que se respira en cada rincón de nuestro restaurante. Aquí, cada plato es un pretexto para celebrar y cada canción, una invitación a levantarte de la silla y bailar. Si lo tuyo es el deleite auditivo y gustativo, estás en el lugar indicado.
                              </p>
                          </div>
                          ...
                          <>
                              ...
                              >
                                  ...
                                  <div>
                                      <YouTube videoId="VkKACB3bgpU" opts={opts} onReady={videoOnReady} />
                                  ...
                                  <Link href="/reserva">
                                      ...
                                      >
                                          ...
                                          <div>
                                              <YouTube videoId="y_6bqXkCeRY" opts={opts} onReady={videoOnReady} />
                      ...
                      <>
                          ...
                          <div className='row-qh px-4'>
                              <h4 className={title.fontTitleSub}>Ven a disfrutar de un gran
                                  </h4>
                              ...
                              <div className="py-0 px-4 row-qh">
                                  <p className="text-center sm:text-2xl text-xl text-black">
                                      ...
                                      <br />
                                      Pero eso no es todo, <b>nuestra cocina te espera con platos irresistibles, diseñados para hacer que cada bocado sea un viaje de sabor</b>. Y para maridar tus comidas, te presentamos nuestra mixología especial con <b>tequila y mezcal, creaciones originales que te sorprenderán</b>.
                                      <br />
                                      Así que, si estás buscando el lugar perfecto para disfrutar de buena música, comida deliciosa y cocteles excepcionales, <b>La Cantina La Llorona </b>es el lugar que necesitas. ¡Te esperamos con los brazos abiertos y las copas listas para brindar! Ven a vivir la verdadera esencia de la fiesta y la gastronomía en nuestro rincón. ¡Nos vemos pronto!"
                                  </p>
                              </div>
                              ...
                              <>
                                  ...
                                  >
                                      ...
                                      <div>
                                          <YouTube videoId="3-8GHQiU5vs" opts={opts} onReady={videoOnReady} />
                                      ...
                                      <Link href="/reserva">
                                          ...
                                          >
                                              ...
                                              <div>
                                                  <YouTube videoId="k9OW0v_kKeY" opts={opts} onReady={videoOnReady} />
                  ...
                  <>
                              ...
                              >
                                  ...
                                  <Link href="/reserva">
                                      <div>
                                          ...
                                          />
                                          <p className="textoFotosHome text-black">
                                              Great salsa <br/>orchestras gathered here
                                          </p>
                                      </div>
                                  </Link>
                                  <Link href="/reserva">
                      ...
                      <>
                          <div className='row-qh px-4'>
                              <h4 className={title.fontTitleSub}>Come enjoy a great
                              </h4>
                              <h2 className={title.fontTitleline}>Son Cubano</h2>
                              <div className="linea"></div>
                          </div>
                              ...
                              <div className="py-0 px-4 row-qh">
                                  <p className="text-center sm:text-2xl text-xl text-black">
                                      ...
                                      So, if you're looking for the perfect place to enjoy <b>good music, delicious food, and exceptional cocktails, Cantina La Llorona is the place you need</b>. We await you with open arms and glasses ready to toast! Come and experience the <b>true essence of celebration and gastronomy in our corner</b>. See you soon!
                                  </p>
                              </div>
                                  ...
                                  >
                                      ...
                                      <Link href="/reserva">
                                          <div>
                                              ...
                                              />
                                              <p className="textoFotosHome text-black">
                                                  Great Live <br />Salsa Orchestras
                                              </p>
                                          </div>
                                      </Link>
                                      <Link href="/reserva">
