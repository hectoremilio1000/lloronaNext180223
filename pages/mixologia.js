        ...
        {espa ? (
          <div className="d-flex w-44 sm:w-60 md:w-80 mx-2 title-portada">
            <h3 className=" font-weight-bold proximamente2 text-white">
              <b>
                Mixología mexicana <br />
                utilizando ingredientes y destilados tradicionales de México
              </b>
            </h3>
          ...
          <div className="d-flex w-44 sm:w-60 md:w-80 mx-2 title-portada">
            <h3 className=" font-weight-bold proximamente2 text-white">
              <b>
                Mexican mixology <br />
                using traditional ingredients and distillates from Mexico
              </b>
            </h3>
      ...
      {espa ? (
        <div className="container-llorona">
          <div className="mt-2 px-2 py-2">
            ...
            <h2 className={title.fontTitleline}>de la mixología</h2>
            <div className="linea"></div>
          </div>

          <div className="py-3 px-3 row-qh">
            <p className="text-center text-black sm:text-2xl text-xl">
              Nuestra barra de mixología no es simplemente un lugar para
              disfrutar de una bebida, es un{' '}
              <b>rincón donde la cultura mexicana y la innovación </b>se
              encuentran para celebrar la magia de nuestros sabores autóctonos.
              Nos especializamos en utilizar destilados tradicionales mexicanos,
              como <b>el tequila, el mezcal y el tepache,</b> y los
              transformamos en cócteles excepcionales mediante técnicas modernas
              y vanguardistas.
            </p>
          </div>
