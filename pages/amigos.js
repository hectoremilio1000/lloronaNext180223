...
import MySwiper from "../components/Swiper2";
                ...
                <div className="w-full max-w-[1184px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-8 text-center">
                  <div className="w-full">
                    ...
                    <p className="text-start text-white sm:text-xs md:text-2xl mt-3">
                      La <b>Llorona es el nuevo hot spot del momento </b> para
                      que vengas a disfrutar de una tarde o noche con tus amig@s
                      en un lugar espectacular con un diseño único que te
                      sorprenderá.
                    </p>
                  </div>
                  <div className="w-full">
