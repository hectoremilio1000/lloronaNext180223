...
const Graciasfacebookroadopening = () => {
  return (
    <div className="h-[100vh] w-full bg-black py-[120px] flex flex-col justify-center items-center fixed z-[6000] left-0 right-0">
      <div className="w-full max-w-[1184px] mx-auto flex flex-col items-center">
        ...
        <p className="text-xl text-white text-center mx-auto max-w-[700px]">
          Gracias por elegir Cantina La Llorona para el evento roadopening! Nos
          llena de alegría saber que has decidido reservar una mesa con
          nosotros. Estamos emocionados de poder brindarte una velada
...
export default Graciasfacebookroadopening;
