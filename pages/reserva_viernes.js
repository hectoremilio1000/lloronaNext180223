...
function Reserva() {
  ...
  useEffect(() => {
    fbq.event('ViewContent', {
      content_name: 'Pagina Reserva Viernes',
  ...
  return (
    <>
      ...
      <>
        {espa ? (
          <Head>
            <title>Cantina para el viernes en la Roma | Cantina La Llorona</title>
            <meta name="description" content="Cierra la semana en Cantina La Llorona. Reserva tu viernes en la Roma Condesa: musica en vivo, mezcales artesanales y pinata cumpleañera con botella de mezcal." />
            <link rel="canonical" href="https://lalloronacantina.com/reserva_viernes/" />
            <meta property="og:title" content="Cantina para el viernes en la Roma | Cantina La Llorona" />
          ...
          <Head>
            <title>Friday Night Cantina in Roma, Mexico City | Cantina La Llorona</title>
            <meta name="description" content="Close the week at Cantina La Llorona. Book your Friday in Roma Condesa: live music, artisanal mezcal and a birthday pinata with a bottle of mezcal." />
            <link rel="canonical" href="https://lalloronacantina.com/reserva_viernes/" />
            <meta property="og:title" content="Friday Night Cantina in Roma, Mexico City | Cantina La Llorona" />
              ...
              <div className="w-full max-w-[1184px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-8 text-center">
                <div className="w-full">
                  <h1 className="font-bold text-4xl text-white">
                    {' '}
                    Los viernes piñata cumpleañera con botella de mezcal
                    artesanal
                  </h1>
                  ...
                  <p className="text-start text-white sm:text-xs md:text-md mt-3">
                    ...
                    los viernes si cumples años en el mes ❤️ y solo tienen que
